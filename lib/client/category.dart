...
class Category extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            buildCategorySection(
              context,
              "Services",
              sealTech.allproducts
                  .where(
                      (product) => product.category == ProductCategory.Services)
                  .toList(),
            ),
            SizedBox(height: 16),
            buildCategorySection(
            ...
            buildCategorySection(
              ...
              sealTech.allproducts
                  .where((product) =>
                      product.category == ProductCategory.Chemicals)
                  .toList(),
            ),
          ],
        ),
  ...
  Widget buildCategorySection(
      BuildContext context, String categoryTitle, List<Product> categoryItems) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
                ...
                GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: ProductPage(
                      ...
                      price: categoryTitle == "Services"
                          ? '${(item.price).toStringAsFixed(2)} million LKR +'
                          : '${item.price.toStringAsFixed(2)} LKR',
                    ),
                  ),
                ),
            ],
